        ...
        try {
            if ($request->ajax()) {
                ...
                return DataTables::of($data)
                    ->editColumn('description',  function(Permission $permission) {
                    ...
                    ->addColumn('action', function ($row) {
                        $btn = '<a href="' . route('permission.edit', $row->uuid) . '" class="btn btn-outline-theme"><i class="fas fa-edit"></i></a>
                                <a href="' . route('permission.show', $row->uuid) . '" class="btn btn-outline-theme"><i class="fas fa-eye"></i></a>
