...
<div id="header" class="app-header">
    ...
    <div class="brand">
        ...
        @if(\App\Helpers\Helper::logo() != null)
            @if(\App\Helpers\Helper::logo()['logo'] != null)
                <div class="brand-logo">
					<span class="brand-img">
                <img class="p-0 m-0" src="{{asset("storage/logos/".\App\Helpers\Helper::logo()['logo'])}}" alt="" srcset="" style="height: 70%;width:70%">
                        </span>
                </div>
            @else
                <div class="brand-logo">
					<span class="brand-img">
                <img class="p-0 m-0" src="{{asset("assets/images/logo-isl.png")}}" alt="" srcset="" style="height: 70%;width:70%">
                        </span>
                </div>
            @endif
        @else
...
{{--					<span class="brand-img">--}}
{{--						<span class="brand-img-text text-theme">POS</span>--}}
{{--					</span>--}}
{{--            </a>--}}
        @endif
    </div>
            ...
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                @if(\App\Helpers\Helper::profile() != null)
                    <div class="menu-img online">
                        <div
                            ...
                            @if(\App\Helpers\Helper::profile()['image'] != null)
                                <img src="{{asset('storage/images/profile/'. App\Helpers\Helper::profile()['image'])}}"
                                     alt="" srcset="">
                            @else
                    ...
                    <div class="menu-text d-sm-block d-none">
                        Hi, {{ ucwords(App\Helpers\Helper::profile()['name']) ?? '' }} </div>
                @else
                    <div class="menu-img online">
                        <div
                            class="d-flex align-items-center justify-content-center w-100 h-100 bg-white bg-opacity-25 text-white text-opacity-50 rounded-circle overflow-hidden">
                    ...
                    <div class="menu-text d-sm-block d-none">Hi ..!</div>
                @endif
            </a>
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                @if(\App\Helpers\Helper::showProfile()['uuid'] != null ?? '' )
                    <a class="dropdown-item d-flex align-items-center"
                       href="{{ route('profile.show', App\Helpers\Helper::showProfile()['uuid'])}}">VIEW PROFILE <i
                            class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
                @else
                    <a class="dropdown-item d-flex align-items-center"
                       href="{{route('profile.edit', Auth::user()->uuid ?? '')}}">EDIT PROFILE <i
                            class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
                @endif
                ...
                @if(Auth::user() != null)
                    <a class="dropdown-item d-flex align-items-center fs-13px"
                       href="{{route('user.password.request')}}">Reset Pass<i
                            class="bi bi-key-fill ms-auto text-theme fs-16px my-n1"></i></a>
                @endif
