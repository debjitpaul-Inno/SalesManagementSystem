    ...
    <div id="content" class="app-content">
        <div class="container">
            ...
            <div class="row mb-2">
                ...
                <div class="col-xl-12">
                    <div class="ms-auto">
                        <a href="{{route('sms-template.create')}}" class="btn btn-outline-theme float-end mt-5 mb-3"><i class="fa fa-plus-circle fa-fw me-1"></i> Add Template</a>
                    </div>
                </div>
            </div>
            <div class="row">
