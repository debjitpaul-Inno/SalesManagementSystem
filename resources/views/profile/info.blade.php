    ...
    <div id="content" class="app-content">
        <div class="row">
            ...
            <div class="align-items-center">
                <div class="col-12">
                    <h1 class="page-header mb-0">Profile Information</h1>
                </div>
                @if($data != null)
                    <div class="ms-auto col-12">
                             <span class="menu-icon">
                                <a href="{{route('profile.edit',Auth::user()->uuid ?? '')}}"
                                   class="btn btn-outline-theme btn-lg active float-end"> <i
                                        class="bi bi-pen-fill ml-5"></i> Edit Profile</a>
                             </span>
                    </div>
                @endif
                <div class="col-9">
                            ...
                            <div class="profile-sidebar">
                                <div class="desktop-sticky-top">
                                    <div class="profile-img">
                                        @if($data->image != null)
                                            <img src="{{asset("storage/images/profile/".$data->image)}}"
                                                 alt="image">
                                        @else
