...
<body class='pace-top'>
<!-- BEGIN #app -->
<div id="app" class="app app-full-height app-without-header d-flex">
    <!-- BEGIN register -->
    <div class="mt-4 ms-4">
        <span class="menu-icon">
                                <a href="{{route('user.index')}}" class="btn btn-outline-theme btn-md active  mb-2"> <i
        ...
        <div class="card  p-3">
            ...
            <div class="card-body">
                ...
                <div class="register-content">
                    <form action="{{ route('user.store') }}" method="POST" name="register_form">
                        @csrf
                        <h1 class="text-center">Sign Up</h1>
                        <p class="text-white text-opacity-50 text-center">One Admin ID is all you need to access all the Admin
                            services.</p>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role_id[]" id="ex-search" class="form-control roles" multiple required>
                        ...
                        <div class="text-white text-opacity-50 text-center">
                            Already have an Admin ID? <a href="{{ route('login-page') }}">Sign In</a>
                        </div>
                    </form>
                </div>
