    ...
    <div id="content" class="app-content p-1 ps-xl-4 pe-xl-4 pt-xl-3 pb-xl-3">
        ...
        <div class="pos card" id="pos">
            <div class="pos-container card-body" style="overflow:hidden">
                ...
                <!-- BEGIN pos-sidebar -->
                <form id="createForm " method="POST" action="{{route('stock-in.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="pos-sidebar" id="pos-sidebar">
                        <div class="h-100 d-flex flex-column p-0">
                                ...
                                <ul class="nav nav-tabs nav-fill p-0">
                                    <li class="nav-item p-0">
                                        <a class="nav-link active" href="#" data-bs-toggle="tab"
                                           data-bs-target="#newOrderTab">Purchase <span class="required"> *</span><span id="countOrder"></span></a>
                                    </li>
                                    <li class="nav-item p-0">
                                    ...
                                    <li class="nav-item p-0">
                                        <a class="nav-link" href="#" data-bs-toggle="tab" data-bs-target="#accountTab">Account<span class="required"> *</span></a>
                                    </li>
                                </ul>
                            </div>
                            <!-- END pos-sidebar-nav -->
                            ...
                            <div class="pos-sidebar-body tab-content" data-scrollbar="true" data-height="100%">
                                <!-- BEGIN #newOrderTab -->
                                <div class="tab-pane fade h-100 show active" id="newOrderTab" style="overflow-x: hidden"></div>
                                <!-- END #newOrderTab -->
                                ...
                                <div class="tab-pane fade h-100" id="vendorTab" style="overflow-x: hidden">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center mb-2 row form-group">
                                            <div class="col-md-4 text-start ms-2">Phone No<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                ...
                                                <input type="text" class="form-control mr-5" name="phone_number"
                                                       id="vendor_phone" value="" style="max-width: 71%" onkeyup="countNumber()">
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('phone_number'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-2 row form-group">
                                            <div class="col-md-4 text-start ms-2">Name<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="vendor_name"
                                                       id="vendor_name" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_name'){{ $message }}@enderror</span>
                                            </div>
                                            <input type="text" id="vendor_id" value="" name="vendor_id"
                                        ...
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">Country<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="vendor_address[country]"
                                                       id="vendor_country" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_address[country]'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">District<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="vendor_address[district]"
                                                       id="vendor_district" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_address[district]'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">P.S/Upazila<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="vendor_address[ps]"
                                                       id="vendor_ps" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_address[ps]'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">Zip Code<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="vendor_address[zip]"
                                                       id="vendor_zip" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_address[zip]'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">Address Line<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <textarea type="text" class="form-control mr-5" name="vendor_address[address_line]"
                                                          id="vendor_address_line" style="max-width: 95%" ></textarea>
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('vendor_address[address_line]'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                        <div class="divider">
                                            <div
                                        ...
                                        <div class="d-flex align-items-center mb-2 row">
                                            <div class="col-md-4 text-start ms-2">Voucher Number<span class="required"> *</span></div>
                                            <div class="flex-1 text-end h6 mb-0 col-md-8 input-group mt-2">
                                                <input type="text" class="form-control mr-5" name="voucher_number"
                                                       id="voucher_number" value="" style="max-width: 95%" >
                                            </div>
                                            <div class="row text-start">
                                                <span class="text-danger ms-2">@error('voucher_number'){{ $message }}@enderror</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="h-100  align-items-center justify-content-center form-group p-2 mt-3">
                                        <div class="d-flex align-items-center mb-2 row form-group">
                                            ...
                                            <div class="flex-1 text-end h6 mb-0 col-md-9 input-group flex-nowrap">
                                                <input type="text" class="form-control" id="taxInput" oninput="calculate_tax()"
                                                       value="0">
                                        ...
                                        <div class="d-flex align-items-center mb-2 row form-group ">
                                            ...
                                            <div class="flex-1 text-end h6 mb-0 col-md-9 input-group text-wrap">
                                                <input type="text" class="form-control" id="cashCollect" name="cashCollect" value="0"
                                                       oninput="change()">
                                                <span class="input-group-text"><small>BDT</small></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="text" class="form-control" name="due" id="due" value="" hidden>
                                        </div>
                                        <hr/>
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <input type="text" class="form-control" name="net_total" id="grandTotal" value=""
                                                   hidden>
                                        </div>
                                    ...
                                    <div class="pos-order-product row mt-2">
                                        <div class="w-100">
                                            ...
                                            <div class="d-flex align-items-center mb-2 row form-group ">
                                                ...
                                                <div class="flex-1 text-end h6 mb-0 input-group text-wrap  ">
                                                    <input type="text" class="form-control amount" id="amount-`+x+`" oninput="calculate_products_price()" name="amount">
                                                    <span class="input-group-text"><small>BDT</small></span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2 row form-group ">
        ...
        function change() {
            ...
            if (document.getElementById("cashCollect").value === "") {
                ...
                if (document.getElementById("vendor_name").value === "" ||
                    ...
                    alert("Please fill-up all the required fields of Supplier portion");
