    ...
    <div id="content" class="app-content">
        <div class="row">
            <div class="align-items-center">
                <div class="col-12">
                    <h1 class="page-header mb-0">Create Sms</h1>
                </div>
                <div class="col-9">
                    <hr/>
                </div>
        ...
        <div id="formControls" class="mb-5">
            <h4>Add Sms From Here</h4>
            <p>You can add <b class="text-theme">Sms</b> as much as you want. To create a <b class="text-theme">
                    Sms</b> just fill up the mandatory input fields. </p>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body pb-2">
                            <form id="createForm" method="POST" action="{{route('sms.store')}}"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subject" name="subject"
                                                   placeholder="Template Subject" required/>
                                        </div>
                                ...
                                <x-submit-button buttonName="Send" icon="bi bi-send-check-fill"></x-submit-button>
                            </form>
                        </div>
                        <x-card-border></x-card-border>
                    </div>
