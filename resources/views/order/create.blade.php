    ...
    <div id="content" class="app-content p-1 ps-xl-4 pe-xl-4 pt-xl-3 pb-xl-3">
        ...
        <div class="pos card" id="pos">
            <div class="pos-container card-body" style="overflow:hidden">
                ...
                <!-- BEGIN pos-sidebar -->
                <form id="createForm" method="POST" action="{{route('order.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="h-100 d-flex flex-column p-0">
                                ...
                                <ul class="nav nav-tabs nav-fill p-0">
                                    <li class="nav-item p-0">
                                        <a class="nav-link active" href="#" data-bs-toggle="tab"
                                           data-bs-target="#newOrderTab">Order <span id="countOrder"></span></a>
                                    </li>
                                    <li class="nav-item p-0">
                            ...
                            <div class="pos-sidebar-body tab-content" data-scrollbar="true" data-height="100%">
                                ...
                                <div class="tab-pane fade h-100 show active" id="newOrderTab">
                                    <div class="mb-3 mt-5 text-center noOrder">
                                    ...
                                    <h5 class="noOrder text-center">No order found</h5>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center mb-2 row form-group">
                                                ...
                                                <div class="flex-1 text-end h6 mb-0 col-md-9 input-group mt-2">
                                                    <input type="text" class="form-control mr-5" name="nickname"
                                                           id="customer_name" value="" style="max-width: 95%" >
                                                </div>
                                ...
                                <div class="tab-pane fade" id="accountTab">
                                    <div class="h-100  align-items-center justify-content-center form-group p-2 mt-2">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <input type="text" class="form-control" name="tax" id="taxValue" value="" hidden>
...
{{--                                        <input type="text" class="form-control" name="status" id="status" value="" readonly hidden>--}}
                                ...
                                <div class="pos-order">
                                    <div class="pos-order-product">
                                        <div class="flex-1">
                                            ...
                                            <input class="product_title_val" type="text" value="` + productitle + `" data-value="` + product_quantity + `" data-price="` + producPrice + `" hidden>
