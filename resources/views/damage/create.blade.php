        ...
        <div class="card h-100">
            <div class="card-body" style="overflow:hidden">
                <div class="row">
                    ...
                    <form id="createForm " method="POST" action="{{route('damage.store')}}"
                                        ...
                                        <div class="pos-order-product row mt-2">
                                            <div class="w-100 d-flex">
                                                <div class=" me-2 form-group " style="width: 30%">
                                                    <select name="product_id[]" id="product_id-1"
                                                            class="form-control select2 products ">
                                                        <option hidden value=""></option>
                                                        @foreach($products as $product)
                                                            <option value="{{ $product->id }}"
                                                                    data-quantity="{{ $product->quantity }}" data-title="{{ $product->title }}">
                                                                {{ $product->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class=" me-2 form-group " style="width: 20%">
                                                    <input type="text" class="form-control " id="unit_price-1"
                                                           name="unit_price" readonly>
                                                </div>
                                                <div class=" me-2 form-group " style="width: 20%">
                                                    <input type="number" class="form-control product-qty" id="qty-1"
                                                           name="qty" min="1" oninput="calculate_products_price(this)">
                                                </div>
                                                <div class=" me-2 form-group " style="width: 20%">
                                                    <input type="text" class="form-control amount" id="amount-1"
